...
<head>
    ...
    <title>Architect &mdash; Premium Version HTML5 Template by freehtml5.co</title>
    ...
    <nav class="fh5co-nav" role="navigation">
        <div class="container">
            <div class="top-menu">
                <div class="row">
                    <div class="col-sm-2">
                        <div id="fh5co-logo"><a href="index.jsp">Architect<span>.</span></a></div>
                    </div>
                    <div class="col-sm-10 text-right menu-1">
                        <ul>
                            <li class="active"><a href="index.jsp">Portfolio</a></li>
                            <li><a href="single.jsp">Single</a></li>
                            <li class="has-dropdown"><a href="single.jsp">Dropdown</a>
                                <ul class="dropdown">
                ...
                <div class="col-md-6 padding-right">
                    <div class="row">
                        <div class="col-md-12 animate-box">
                            <a href="single.jsp" class="portfolio-grid">
